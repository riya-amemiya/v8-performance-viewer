...
# release d8 used for benchmarking with V8's bundled toolchain.
...
cd "$ROOT/v8"
GN_ARGS='is_debug=false dcheck_always_on=false is_component_build=false symbol_level=0 target_cpu="x64"'
